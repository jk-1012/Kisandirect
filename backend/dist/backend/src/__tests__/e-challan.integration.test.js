...
import { EChallanStatus, } from '../types/e-challan';
...
describe('E-Challan Integration Tests', () => {
    ...
    beforeAll(async () => {
        ...
        challanService = createEChallanService(mockServer, mockDb, mockRedis, mockS3, config);
    });
    beforeEach(() => {
        jest.clearAllMocks();
    });
    describe('Challan Creation', () => {
        ...
        it('should throw error for non-existent order', async () => {
            ...
            mockDb.connect.mockResolvedValue(client);
            await expect(challanService.createChallan({ orderId: 'non-existent' })).rejects.toThrow('Order not found');
        });
    ...
    describe('OTP Verification', () => {
        it('should send OTP to phone number', async () => {
            ...
            expect(mockServer.log.info).toHaveBeenCalledWith(expect.stringContaining('OTP sent'));
        });
        ...
        it('should reject invalid OTP', async () => {
            ...
            await expect(challanService.verifyOtp({
                challanId: testChallanId,
                otpCode: '999999',
                recipientType: 'FARMER',
    ...
    describe('Signature Capture', () => {
        ...
        it('should reject signature from wrong signer', async () => {
            ...
            await expect(challanService.signChallan({
                challanId: testChallanId,
                signerName: 'John Farmer',
                signerPhone: '9876543210',
                signatureImageBase64: testSignature,
    ...
    describe('Archival', () => {
        it('should archive completed challans', async () => {
            ...
            expect(mockServer.log.info).toHaveBeenCalledWith(expect.stringContaining('Challan completed'));
        });
        it('should prevent archival of incomplete challans', async () => {
            ...
            await expect(challanService.archiveChallan(testChallanId)).rejects.toThrow('Only completed challans can be archived');
        });
    });
    afterAll(async () => {
