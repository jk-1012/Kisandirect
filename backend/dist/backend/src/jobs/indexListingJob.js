...
export async function indexListingJob(server, listingId) {
    const result = await server.db.query(`SELECT l.*, u.trust_score AS farmer_trust_score, u.kisan_id AS farmer_kisan_id,
